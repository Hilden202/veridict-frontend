...
<style>
    ...
    .tarot-card {
        ...
        width: 100%;
        padding: 32px 42px;
        border: 1px solid rgba(124, 147, 184, 0.28);
        border-radius: 14px;
        background: radial-gradient(
                circle at center,
            ...
            radial-gradient(
                circle at 82% 26%,
                rgba(114, 63, 255, 0.42),
                transparent 26%
            ),
            linear-gradient(135deg, #0d1026, #070b18 52%, #101325);
        color: #ffffff;
        text-decoration: none;
    ...
    .tarot-card:hover {
        ...
        box-shadow: 0 22px 60px rgba(80, 60, 255, 0.25);
        opacity: 1;
    }
    ...
    .tarot-top::after {
        content: "Explore • Reflect • Gain insight";
        font-size: 0.65rem;
        color: rgba(200, 204, 224, 0.6);
    ...
    .tarot-copy strong {
        ...
        padding: 0 16px;
        border-radius: 5px;
        background: linear-gradient(135deg, #2e43d9, #315fff);
        font-size: 0.62rem;
    }
    ...
    .tarot-deck span {
        ...
        width: 88px;
        height: 142px;
        border: 3px solid rgba(221, 177, 76, 0.7);
        border-radius: 11px;
        background: radial-gradient(
                circle at 50% 44%,
                rgba(252, 212, 91, 0.95) 0 14%,
                transparent 15%
            ),
            radial-gradient(
                circle at 30% 20%,
            ...
            linear-gradient(145deg, #6735ca, #2d1c78);
